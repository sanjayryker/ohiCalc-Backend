...
const { get_keyIndScore_EDI, get_keyIndScore_CDI, get_keyIndScore_IDI,get_CategoryScore_All,post_KeyInd_Weight,get_KeyInd_Weight } = require('../controllers/score_Controller')
